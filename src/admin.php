...
<h1><?php print esc_html__( 'Export to Gatsby' ); ?></h1>
<p><?php print esc_html__( 'Export your WordPress content to a zip file to use in a Markdown based Gatsby site like' ); ?> <a target="_blank" href="https://github.com/tinacms/wp-gatsby-exporter/blob/master/README.md#working-with-gatsby">Tina Grande.</a> </p>
<p><?php print esc_html__( 'Running into issues with timeouts on a large site? Try the included WP-CLI command!' ); ?></p>
<form class="gatsby-exporter" method="post">
	<?php wp_nonce_field( 'gatsby_export', 'zip_exporter' ); ?>

	<div class="form-field">
		<label class="form-block"><?php print esc_html__( 'Post types' ); ?></label>
		<?php
	...
	<div class="form-field">
		<label class="form-block" for="post_status"><?php print esc_html__( 'Post status' ); ?></label>
	...
	<div class="form-field">
		<input type="submit" value="<?php print esc_attr__( 'Download Zip File' ); ?>" class="form-block">
	</div>


	<fieldset class="form-more">
		<hr>
		<h2><?php print esc_html__( 'More Export Options' ); ?></h2>
		<div class="form-field">
			<label id="post_date_format_label" for="post_date_format" class="form-block"><?php print esc_html__( 'Export date format' ); ?></label>
			...
			<small id="post_date_format_desc" class="form-block"><?php print esc_html__( 'The format for the exported date, see:' ); ?> <a target="_blank" href="https://www.php.net/manual/en/function.date.php"><?php print esc_html__( 'PHP reference' ); ?></a></small>
		</div>

		<div class="form-field">
			<label id="fields_to_markdown_label" for="fields_to_markdown" class="form-block"><?php print esc_html__( 'Convert fields to Markdown' ); ?></label>
			...
			<small id="fields_to_markdown_desc" class="form-block"><?php print esc_html__( 'One per line. List front matter fields that should be converted to Markdown from HTML.' ); ?></small>
		</div>
		...
		<div class="form-field">
			<label id="skip_original_images_label" for="skip_original_images"><?php print esc_html__( 'Skip using original image dimensions' ); ?></label>
			...
			<small id="skip_original_images_desc" class="form-block"><?php print esc_html__( 'Use images that have been already resized by WordPress, rather than originals.' ); ?></small>
		</div>
	</fieldset>
